...
int main ( int, char** )
{
    ...
    const auto ui_font = io.Fonts->AddFontFromMemoryTTF ( ( void* ) sesame_ui_data, sesame_ui_size, 15.0f, nullptr, custom_font_ranges );
   ...
   // ImGui::GetStyle ( ).ScaleAllSizes ( 2.0f );
    ...
    while ( msg.message != WM_QUIT )
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            static auto test_combobox_options = u8"One\0Two\0Three\0Four\0Five";

            static float test_color []{ 0.8f, 0.2f, 0.95f, 1.0f };

            ImGui::Checkbox ( "Checkbox 1", &test_checkbox_0 );
            ImGui::Checkbox ( "Checkbox 2", &test_checkbox_1 ); ImGui::SameLine ( ); ImGui::ColorEdit4 ( u8"Color Picker", test_color, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel );
            ...
            ImGui::Button ( u8"Save Config" );
            ImGui::Button ( u8"Load Config" );
            ImGui::Button ( u8"Refresh Config List" );

            ImGui::Combo ( u8"Combobox", &test_combobox, test_combobox_options );
